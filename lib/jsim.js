...
//    }
  ...
  execute : function( e ){
    ...
    var cmdObj    = this.commandGenerator( eventObj );
    var returnObj = this.process( cmdObj );
    return returnObj;
  },
  ...
  commandGenerator : function( eventObj ){
  ...
  commands : {
    ...
    toggle : JSIM_dummyCommand,
    disable : JSIM_dummyCommand,
    enable : JSIM_dummyCommand,
    clear : JSIM_dummyCommand,
    selectall : JSIM_dummyCommand
  },
  selectAll : function(){
    this.imeAccept();
    this.imeBox.focus();
